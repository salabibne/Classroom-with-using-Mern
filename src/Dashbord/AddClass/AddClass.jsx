...
const AddClass = () => {
    ...
    const onSubmit = async(data) => {
        ...
        if(img_res.data.success){
            ...
            const dataItem = await privateApi.post("/teacher/addClass",addClassInfo)
            if(dataItem.data.insertedId){
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "adding class info has been forwarded to Admin Panal",
        ...
        <div  className="hero min-h-screen">
            <div className="hero-content mt-8 flex-col">
                <div className="text-center ">
                    <h1 className="text-5xl font-bold mt-8 "> Adding Class Information</h1>
                ...
                <div className="card shrink-0 w-full  shadow-2xl ">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-primary">AddClass</button>
                        </div>
