...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-violet-950 ">
            <nav>
                <img width={180} height={100} className="rounded-full" src={logo}></img>
            </nav>

            <nav>
                <header className="text-green-600 font-bold text-2xl">Programs</header>
                <a className="link link-hover text-white">Web development</a>
                <a className="link link-hover text-white">Data Science</a>
                <a className="link link-hover text-white">Cyber Security</a>
                <a className="link link-hover text-white">Content Writer</a>
            </nav>
            <nav>
                <header className="text-green-600 font-bold text-2xl">About</header>
                <a className="link link-hover text-white">Our Story</a>
                <a className="link link-hover text-white">Carers</a>
                <a className="link link-hover text-white">Get Involved</a>
                <a className="link link-hover text-white">Press & Media</a>
            </nav>
            <nav>
                <header className="text-green-600 font-bold text-2xl">Social</header>
